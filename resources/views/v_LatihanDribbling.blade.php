        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              <ul class="nav navbar-nav">
                ...
                <li><a href="{{route('KeTrackRecord')}}">Track Record</a></li>
...
<br><br><br><br>
    <div class="row">
      ...
      <div class="col-xs-6 col-sm-4">
        <h1 style="text-align : center; color :#ed3237; ">Exercise Dribbling </h1><br>
        <form action="{{route('RecordDribbling')}}" method="post" enctype="multipart/form-data">
        <h4>How Longs Are You Do Today?</h4>
